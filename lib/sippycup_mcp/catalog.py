...
DOCUMENTS = {
    ...
    "mcp": "docs/MCP.md",
    "mcp-live": "docs/MCP-LIVE.md",
    "mcp-security": "docs/MCP-SECURITY.md",
    "webrtc-contracts": "docs/WEBRTC-CONTRACTS.md",
    "webrtc-call-evidence": "docs/WEBRTC-CALL-EVIDENCE.md",
    "webrtc-dtls-srtp": "docs/WEBRTC-DTLS-SRTP.md",
...
SCHEMAS = {
    ...
    "webrtc-exit-gate-v1": "schemas/webrtc-exit-gate-v1.schema.json",
