...
webrtc-test:
	PYTHONPATH=lib PYTHONDONTWRITEBYTECODE=1 python3 -m unittest tests.test_webrtc_contracts tests.test_webrtc_validation_cli tests.test_webrtc_ice_turn tests.test_webrtc_sdp tests.test_webrtc_dtls_srtp tests.test_webrtc_call_evidence -v
